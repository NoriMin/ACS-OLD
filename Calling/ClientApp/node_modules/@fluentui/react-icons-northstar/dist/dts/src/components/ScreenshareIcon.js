...
exports.ScreenshareIcon = createSvgIcon_1.createSvgIcon({
    svg: function (_a) {
        ...
        return (React.createElement("svg", { role: "presentation", focusable: "false", viewBox: "8 8 18 16", className: classes.svg },
            ...
            React.createElement("path", { className: classnames_1.default(iconClassNames_1.iconClassNames.filled, classes.filledPart), d: "M17.492,14a1.531,1.531,0,0,1,1.5,1.5v6a1.531,1.531,0,0,1-1.5,1.5h-7a1.542,1.542,0,0,1-1.5-1.5v-6a1.532,1.532,0,0,1,1.5-1.5Zm4-5a1.531,1.531,0,0,1,1.5,1.5v6a1.531,1.531,0,0,1-1.5,1.5h-1a.5.5,0,0,1-.5-.5c0-.438.383-.516.735-.516.179,0,.351.024.531.024.359,0,.734-.07.734-.508v-6a.5.5,0,0,0-.5-.5h-7c-.469,0-.531.516-.531.875,0,.422.062.828.062,1.25,0,.359-.062.875-.531.875a.5.5,0,0,1-.5-.5v-2a1.532,1.532,0,0,1,1.5-1.5Z" })));
    },
