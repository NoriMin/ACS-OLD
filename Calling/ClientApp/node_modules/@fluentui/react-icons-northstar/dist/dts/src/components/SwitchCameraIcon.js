...
exports.SwitchCameraIcon = createSvgIcon_1.createSvgIcon({
    svg: function (_a) {
        ...
        return (React.createElement("svg", { className: classes.svg, viewBox: "8 8 16 16", role: "presentation", focusable: "false" },
            ...
            React.createElement("path", { className: classnames_1.default(iconClassNames_1.iconClassNames.filled, classes.filledPart), d: "M17.5,8A1.54,1.54,0,0,1,19,9.5v7A1.54,1.54,0,0,1,17.5,18H9.82C8,18,8,14.89,8,13.66V12.34C8,11.1,8,8,9.82,8ZM9.8,18.46a.5.5,0,0,1,.5.5c0,.52-.6.46-.8.83.41.9,4.82,1.2,5.81,1.23C15,20.76,14,19.9,14,19.5a.51.51,0,0,1,.5-.5.47.47,0,0,1,.35.15l2,2a.48.48,0,0,1,0,.7l-2,2a.47.47,0,0,1-.35.15.51.51,0,0,1-.5-.5c0-.38,1-1.23,1.27-1.48-1.34,0-6.77-.32-6.77-2.24A1.59,1.59,0,0,1,9.8,18.46Zm12.4,0a1.58,1.58,0,0,1,1.3,1.32c0,1.44-3.27,2.06-4.36,2.06a.5.5,0,0,1-.5-.5c0-1,3.46-.55,3.86-1.57-.23-.29-.8-.36-.8-.81A.5.5,0,0,1,22.2,18.46ZM23.5,9a.51.51,0,0,1,.5.5v7a.51.51,0,0,1-.5.5.48.48,0,0,1-.34-.14l-2.54-2.41a2,2,0,0,1,0-2.9l2.54-2.41A.48.48,0,0,1,23.5,9Z" })));
    },
