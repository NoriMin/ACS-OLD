...
exports.MeetingTimeIcon = createSvgIcon_1.createSvgIcon({
    svg: function (_a) {
        ...
        return (React.createElement("svg", { role: "presentation", focusable: "false", viewBox: "8 8 18 16", className: classes.svg },
            ...
            React.createElement("path", { className: classnames_1.default(iconClassNames_1.iconClassNames.filled, classes.filledPart), d: "M19.5,23A3.5,3.5,0,1,1,23,19.5,3.5,3.5,0,0,1,19.5,23Zm-4.453-4H14V17h1.758A4.558,4.558,0,0,0,15.047,19ZM14,14h2v2H14Zm3,0h2v1.047a4.558,4.558,0,0,0-2,.711Zm-4,2H11V14h2Zm0,3H11V17h2Zm9-3.242V11.5A1.511,1.511,0,0,0,20.5,10H18V9a.5.5,0,0,0-1,0v1H13V9a.5.5,0,0,0-1,0v1H9.5A1.511,1.511,0,0,0,8,11.5v9.414a1.373,1.373,0,0,0,.3.875,1.682,1.682,0,0,0,.789.516A19.286,19.286,0,0,0,15,23c.547,0,1.094-.016,1.641-.055A4.473,4.473,0,0,0,24,19.5,4.606,4.606,0,0,0,22,15.758ZM20,19h1.5v1H19V17h1Z" })));
    },
