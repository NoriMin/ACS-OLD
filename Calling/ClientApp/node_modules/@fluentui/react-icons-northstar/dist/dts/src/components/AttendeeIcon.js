...
exports.AttendeeIcon = createSvgIcon_1.createSvgIcon({
    svg: function (_a) {
        ...
        return (React.createElement("svg", { className: classes.svg, viewBox: "8 8 16 16", role: "presentation", focusable: "false" },
            ...
            React.createElement("path", { className: classnames_1.default(iconClassNames_1.iconClassNames.filled, classes.filledPart), d: "M8,18v2.92C8,22.5,9.7,23,11,23h.5a.51.51,0,0,0,.5-.5V18Zm11,0H13v3.93C13,23.49,14.72,24,16,24s3-.48,3-2.07Zm5,0H20v5h1c1.3,0,3-.5,3-2.08ZM13,12a2,2,0,1,0-2-2A2,2,0,0,0,13,12Zm6,0a2,2,0,1,0-2-2A2,2,0,0,0,19,12Zm-3,5a2,2,0,1,0-2-2A2,2,0,0,0,16,17Zm-6,0a2,2,0,1,0-2-2A2,2,0,0,0,10,17Zm12,0a2,2,0,1,0-2-2A2,2,0,0,0,22,17Z" })));
    },
