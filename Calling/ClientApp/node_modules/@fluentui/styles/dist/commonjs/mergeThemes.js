...
var mergeComponentStyles__PROD = function mergeComponentStyles__PROD() {
  var initial = {};
  ...
  return sources.reduce(function (partStylesPrepared, stylesByPart) {
    (0, _forEach2.default)(stylesByPart, function (partStyle, partName) {
      ...
      if (typeof originalTarget === 'undefined') {
        partStylesPrepared[partName] = typeof originalSource === 'function' ? originalSource : (0, _callable.callable)(originalSource);
        return;
      ...
      partStylesPrepared[partName] = function (styleParam) {
        ...
        return (0, _merge2.default)(originalTarget(styleParam), (0, _callable.callable)(originalSource)(styleParam));
      };
    });
...
var mergeComponentStyles__DEV = function mergeComponentStyles__DEV() {
    ...
    (0, _forEach2.default)(stylesByPart, function (partStyle, partName) {
      ...
      if (typeof originalTarget === 'undefined') {
        partStylesPrepared[partName] = function (styleParam) {
          ...
          var _ref = (0, _callable.callable)(originalSource)(styleParam) || {},
      ...
      partStylesPrepared[partName] = function (styleParam) {
        ...
        var _originalTarget = originalTarget(styleParam),
            ...
            targetStyles = (0, _objectWithoutPropertiesLoose2.default)(_originalTarget, ["_debug"]);

        var _ref2 = (0, _callable.callable)(originalSource)(styleParam) || {},
            _ref2$_debug = _ref2._debug,
            sourceDebug = _ref2$_debug === void 0 ? undefined : _ref2$_debug,
            sourceStyles = (0, _objectWithoutPropertiesLoose2.default)(_ref2, ["_debug"]);
