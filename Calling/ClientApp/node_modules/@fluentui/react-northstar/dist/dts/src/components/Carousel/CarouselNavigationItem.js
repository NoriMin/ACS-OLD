 ...
 */
exports.CarouselNavigationItem = function (props) {
    ...
    setStart();
    var children = props.children, thumbnails = props.thumbnails, vertical = props.vertical, active = props.active, content = props.content, iconOnly = props.iconOnly, primary = props.primary, indicator = props.indicator, className = props.className, design = props.design, styles = props.styles, variables = props.variables;
    ...
    var element = (React.createElement(ElementType, tslib_1.__assign({}, getA11yProps('root', tslib_1.__assign({ className: classes.root, onBlur: handleBlur, onFocus: handleFocus, onClick: handleClick }, unhandledProps)), utils_1.rtlTextContainer.getAttributes({ forElements: [children] })), utils_1.childrenExist(children) ? children : renderContent()));
    setEnd();
    return element;
};
exports.CarouselNavigationItem.displayName = 'CarouselNavigationItem';
exports.CarouselNavigationItem.propTypes = tslib_1.__assign(tslib_1.__assign({}, utils_1.commonPropTypes.createCommon()), { active: PropTypes.bool, indicator: customPropTypes.shorthandAllowingChildren, iconOnly: PropTypes.bool, index: PropTypes.number, onClick: PropTypes.func, primary: customPropTypes.every([customPropTypes.disallow(['secondary']), PropTypes.bool]), secondary: customPropTypes.every([customPropTypes.disallow(['primary']), PropTypes.bool]), vertical: PropTypes.bool, thumbnails: PropTypes.bool });
