...
exports.Popup = function (props) {
    ...
    var handleDocumentKeyDown = function (getRefs) { return function (e) {
        var keyCode = keyboard_key_1.getCode(e);
        var isMatchingKey = keyCode === keyboard_key_1.keyboardKey.Enter || keyCode === keyboard_key_1.SpacebarKey;
        ...
        if (keyCode === keyboard_key_1.keyboardKey.Escape && bodyHasFocus && isLastOpenedPopup) {
            close(e, function () { return _.invoke(triggerFocusableRef.current, 'focus'); });
        }
    }; };
    ...
    var updateContextPosition = function (nativeEvent) {
        rightClickReferenceObject.current = nativeEvent ? createReferenceFromContextClick_1.createReferenceFromContextClick(nativeEvent) : null;
    };
    ...
    var contentElement = (React.createElement(Animation_1.Animation, { mountOnEnter: true, unmountOnExit: true, visible: open, name: open ? 'popup-show' : 'popup-hide' }, function (_a) {
        ...
        return (React.createElement(positioner_1.Popper, { pointerTargetRef: pointerTargetRef, align: align, flipBoundary: flipBoundary, popperRef: popperRef, position: position, positionFixed: positionFixed, offset: offset, overflowBoundary: overflowBoundary, rtl: context.rtl, unstable_pinned: unstable_pinned, targetRef: rightClickReferenceObject.current || target || triggerRef }, renderPopperChildren(classes)));
    }));
    ...
    var element = (React.createElement(React.Fragment, null,
        triggerElement,
        inline ? contentElement : React.createElement(PortalInner_1.PortalInner, { mountNode: mountNode }, contentElement)));
    setEnd();
    return element;
};
