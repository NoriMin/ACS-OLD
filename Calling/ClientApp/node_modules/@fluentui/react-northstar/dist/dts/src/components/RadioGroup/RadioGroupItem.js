...
exports.RadioGroupItem = function (props) {
    ...
    setStart();
    var label = props.label, indicator = props.indicator, disabled = props.disabled, vertical = props.vertical, className = props.className, design = props.design, styles = props.styles, variables = props.variables, shouldFocus = props.shouldFocus;
    ...
    var handleClick = function (e) {
        ...
        setChecked(function (prevChecked) {
            _.invoke(props, 'onChange', undefined, tslib_1.__assign(tslib_1.__assign({}, props), { checked: !prevChecked }));
            return !prevChecked;
        });
    };
