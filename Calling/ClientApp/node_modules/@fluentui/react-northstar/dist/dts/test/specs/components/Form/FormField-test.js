...
describe('FormField', function () {
    commonTests_1.isConformant(FormField_1.FormField, { constructorName: 'FormField' });
    ...
    it('renders with icon and error message', function () {
        var formField = utils_1.mountWithProvider(React.createElement(FormField_1.FormField, tslib_1.__assign({}, {
            label: 'First name',
            name: 'firstName',
        ...
        expect(formField
            .find("." + FormField_1.formFieldMessageClassName)
            .at(0)
            .getDOMNode().textContent).toBe('ERROR');
    });
