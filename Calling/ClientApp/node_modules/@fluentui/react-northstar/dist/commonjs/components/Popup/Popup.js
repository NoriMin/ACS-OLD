...
var _createReferenceFromContextClick = require("./createReferenceFromContextClick");
...
var Popup = function Popup(props) {
  ...
  var handleDocumentKeyDown = function handleDocumentKeyDown(getRefs) {
    return function (e) {
      var keyCode = (0, _keyboardKey.getCode)(e);
      var isMatchingKey = keyCode === _keyboardKey.keyboardKey.Enter || keyCode === _keyboardKey.SpacebarKey;
      ...
      if (keyCode === _keyboardKey.keyboardKey.Escape && bodyHasFocus && isLastOpenedPopup) {
        _close(e, function () {
          return (0, _invoke2.default)(triggerFocusableRef.current, 'focus');
        });
      }
  ...
  var renderPopperChildren = function renderPopperChildren(classes) {
    return function (_ref) {
      ...
      return /*#__PURE__*/React.createElement(_reactComponentNestingRegistry.Unstable_NestingAuto, null, function (getRefs, nestingRef) {
        return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_reactComponentRef.Ref, {
        ...
        }, popupContent), /*#__PURE__*/React.createElement(_reactComponentEventListener.EventListener, {
          ...
          type: "keydown",
          capture: true
        }), isOpenedByRightClick && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_reactComponentEventListener.EventListener, {
  ...
  var trySetOpen = function trySetOpen(newValue, event) {
    var isOpenedByRightClick = newValue && (0, _isRightClick.isRightClick)(event); // when new state 'open' === 'true', save the last focused element
  ...
  var updateContextPosition = function updateContextPosition(nativeEvent) {
    rightClickReferenceObject.current = nativeEvent ? (0, _createReferenceFromContextClick.createReferenceFromContextClick)(nativeEvent) : null;
  };
  ...
  var triggerNode = (0, _utils.childrenExist)(children) ? children : trigger;
  ...
  var contentElement = /*#__PURE__*/React.createElement(_Animation.Animation, {
    ...
    return /*#__PURE__*/React.createElement(_positioner.Popper, {
  ...
  var element = /*#__PURE__*/React.createElement(React.Fragment, null, triggerElement, inline ? contentElement : /*#__PURE__*/React.createElement(_PortalInner.PortalInner, {
    mountNode: mountNode
  }, contentElement));
  setEnd();
  return element;
