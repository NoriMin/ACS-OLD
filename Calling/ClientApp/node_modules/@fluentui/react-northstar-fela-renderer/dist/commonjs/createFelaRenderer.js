...
var createFelaRenderer = function createFelaRenderer(target) {
  var felaRenderer = (0, _fela.createRenderer)(rendererConfig); // rehydration disabled to avoid leaking styles between renderers
  // https://github.com/rofrischmann/fela/blob/master/docs/api/fela-dom/rehydrate.md

  var Provider = function Provider(props) {
    return /*#__PURE__*/React.createElement(_reactFela.RendererProvider, (0, _extends2.default)({
